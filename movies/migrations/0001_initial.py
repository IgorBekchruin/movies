# Generated by Django 4.1 on 2022-10-17 16:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('world_premier', models.DateField(default=datetime.date.today, verbose_name='Мировая премьера')),
                ...
                ('directors', models.ManyToManyField(related_name='film_directors', to='movies.actor', verbose_name='режиссер')),
